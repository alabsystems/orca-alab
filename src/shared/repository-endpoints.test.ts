...
describe('repository endpoints', () => {
  ...
  it('keeps source and issue traffic on the ALab development repository', () => {
    expect(ORCA_ALAB_DEVELOPMENT_REPOSITORY_SLUG).toBe('alabsystems/orca-alab')
    expect(ORCA_ALAB_DEVELOPMENT_REPOSITORY_URL).toBe('https://github.com/alabsystems/orca-alab')
    expect(ORCA_ALAB_DEVELOPMENT_ISSUES_URL).toBe(
      'https://github.com/alabsystems/orca-alab/issues'
    )
    expect(ORCA_ALAB_DEVELOPMENT_NEW_ISSUE_URL).toBe(
      'https://github.com/alabsystems/orca-alab/issues/new'
    )
    expect(ORCA_ALAB_DEVELOPMENT_DOCS_URL).toBe(
      'https://github.com/alabsystems/orca-alab/tree/main/docs'
    )
    expect(ORCA_ALAB_FEATURE_WALKTHROUGH_URL).toBe(
      'https://github.com/alabsystems/orca-alab/blob/main/FEATURE_WALKTHROUGH.md'
    )
    ...
    expect(ORCA_ALAB_PRIVACY_URL).toBe(
      'https://github.com/alabsystems/orca-alab/blob/main/docs/reference/privacy-staging.md'
    )
  })
})
